...
Awarded a scholarship to undergo mobile journalism in Albania.`,
...

  {
    ...
    title: `Heavenly Path`,
    writeup: `The photograph was taken while taking a walking in a park built along the bank of the river Brahmaputra in Guwahati city. I happened to pass through this particular pathway and thought it looked like a path to a different world.`,
...

  {
    ...
    writeup: `The mighty river the Brahmaputra has provided the people of Assam and all the regions it flows through with not only food and water but also has provided the people with a source of employment. Freshwater fishing is the primary source of income for hundreds if not thousands of people living by this mighty river.
    
    For centuries, hundreds of families have been dependent on the river for their food, clean water and fishing as employment opportunities. River-based fisheries are of particular importance in tropical regions as they provide food and nutrition to millions of people and support their livelihood. In recent times, the ever-increasing demands of water for irrigation, agriculture, domestic and industrial use and hydropower generation have impacted the river flow and habitats and consequently the fisheries and river-fish dependent communities.
    
    The Assamese and Bengali populations are very fond of fish and thus every morning the markets of Guwahati are flooded with hundreds of kilograms of fish. While we people love to consume fish almost every single day, we hardly think about the communities of fishermen who wake up in the middle of the night to go out into the river to meet our demand for fish every single day. Having spoken to a few of them, I’ve come to know about the hardships they face and would personally like to thank them for their contribution to our society. My photographs display these fishermen hard work and also the various methods and traditional techniques of catching fish using bamboo and nets.`,
