...
const newData = [
  ...
  },
  {
    ...
    writeup: `This collection of images is a chronicle of visits to the river at various points, made over 10 years. In my travels across Assam and Arunachal Pradesh, I have always found myself never too far from its expansive landscapes or by a smaller tributary; often crossing paths with the waters - a privilege in itself. 
    
    Growing up in Tinsukia, for instance, it was a thirty-minute drive to the Dibru- Saikhowa National Park which became our de-facto day out and also where my family would take their guests first. News of the gas blowout near the park last year was gut-wrenching to live with, since I personally knew many boat operators and guides whose families depended upon the river for their livelihoods.
  ...
  },
  {
    ...
    title: `Into Prayers`,
    writeup: `The River is sacred to Hindus, Pilgrims travel thousands of miles to pray and bathe themselves in the river as part of a purification ritual. India is a land of festivals that are celebrated throughout the year in different corners of the country with joy and enthusiasm.
    
    Lakhs of devotees from across the country gather every day at River Banks to offer prayers. There are different rituals that take place, mainly in the Morning and in the Evening, to complete these rituals, devotees have to stand at the banks of the rivers for long hours. Standing in a river and praying release energy from your body.
    
    It is believed that these rituals of standing in the water and praying detoxify the body and mind and provides mental calmness. It also enhances immunity, infuses energy and reduces the frequency of anger, and all other negative emotions`,
...

  {
    ...
    writeup: `Spent my teenage years next to the river. And then I was uprooted and sent off to attend college in the extreme west of the country. I hated the change. I missed my friends, the hills, the abundance of greens but most of all I missed the river from my backyard.
    
    The might of the river of been lavishly written about. Her travel from Himalaya to Bay of Bengal is an adventure in itself. Her ever-changing forms imitate life. How she makes people feel is spun into poems and songs. I strongly believe that the river has a pull, an attraction, a gravity of its own which plays on people of all kinds – fisher folk, farmers, dating couples, children, elders and on me. While identities of people in North East often clash in insider-outsider binaries, the river unifies. She connects the disconnected. She can bridge boundaries and borders.
    
    After studying and working across India, this enormity of the Brahmaputra pulled me back to her after 20 years. Now when I touch her waters, it feels as if I never left. She is the center of my friendships in the city. She is my family here.`,
  ...
  },
  {
    ...
    writeup: `The mighty Brahmaputra has been the harbinger of life for the city of Guwahati to the point that the city cannot even be imagined without it. Despite the destructive annual floods which lead to loss of land, life and livestock, the river remains the most cherished attribute of the city. For a state dependent on rice cultivation and fishing, the river is undoubtedly the primary source of life and livelihood. One cannot easily comprehend the magnitude of the Brahmaputra’s impact on the lives of the people of the city of Guwahati, and the state of Assam at large. Settlements by the banks of rivers are a common phenomenon across the world. Given the alluvial soil around the Brahmaputra, it is only natural that populations have settled very close to its shores.
    
    For the people who have settled in colonies just by the banks, the river means more to them than a mainstream city dweller could ever imagine. Their day begins with a prayer to the sun, taking a holy dip in the water. Their livelihood depends mostly on the river; some belong to fishing communities, cloth washing communities, boating communities, and vendors who bring produce from their remote villages in the ferries to be sold in the city.
  ...
  },
  {
    ...
    title: `Symbiosis`,
    writeup: `The first photograph: It represents the life and colour of the villagers residing in the bank of river Brahmaputra. A lady heads in search of her cattle during sunset.
    
    The second photograph: The water buffaloes loves their bath during summer and relaxes in Brahmaputra River.
    
    The third photograph: The occupation of the villagers residing in the banks are mostly fishing, cattle rearing and farming. They sell their products in the nearby town markets. This photograph is of a villager crossing a fertile river land where they keep their cattle.
    
    The fourth photograph: A fisherman fishing in Brahmaputra River during a sunset.`,
  ...
  },
  {
    ...
    title: `Energy`,
    writeup: `The son of Brahma, river Brahmaputra has been a source of life, livelihood and inspiration for many. The strength and agility of this river making its way amidst the steep cut mountains to the valleys of culture, signifies a powerful journey called life. The serene, quite, and otherwise calm nature of the river symbolizing the enchanting hues of existence goes along with the wrath of that furious rage where it strives for freedom reflecting on the turmoil, distress and tumultuous waters of the region.
    
    The river is us and its primordial voyage from the cradle of dawn to the heights of civilization is the decadence of mankind. What is it to live with something? Is it the same as livelihood? Is it more, is it less? It is definitely much more. The river correlates with people’s emotions, they need to flow. River makes emotions look like energy in motion. Stopping the flow means blocking the energy. Thus it surely is not about the livelihood. It encompasses the sentimentalities.
    
    I personally feel that when I say living, it means longer than staying, something which is more permanent in relation to staying which might be temporary. So, it is the longer residence with it that increases its significance and experience for them. Bruises left by the sudden wrath and destruction of the river also however calm down. People get accustomed to this inner complaint.
    
    Living means being there in both its bad and good; when you cannot always expect to be perfect but love it nonetheless with its occasional hiccups to let go. The world is a small place to accommodate this huge chunk of people, so humans have always attempted to settle down whosesoever they find a small patch of land even if it is in the middle of the river and sometimes in a tiny little boat. There is probably a river in each of our lives. The literal reflection on the water can also be seen as a kind of mirror reflection of the boatman and the river living with and in each other. Channelizing energy though each other.`,
...

  {
    ...
    writeup: `These pictures were taken as part of my MPhil research in Majuli to understand the Re-theorizing livelihood practices due to twin process of flood and river bank erosion, soil and its materiality for community also how it has changed over decades. The manifestation of flood in Assam has been a perennial occurrence in Brahmaputra valley and it has been boon and sorrow for the community at the same time. 
        
        The potter community ‘Kumars’ from Salmora (Majuli. Assam) expressed this artistry has been the mainstay of the livelihood and income as the men from the household sail to Sadia, Tezpur, Lakhimpur districts and other neighboring districts to sell the pots on their country made boats. The income generated from it is used a means of sustenance to cope from deluge. However, due to the rapid flood and river bank erosion, it has been continuously eroding/washing away the ‘Kumar matti’ shown in first and second picture used by the potters as they face existential crisis of their traditional livelihood and it has been now dwindling due to the rapid floods.
        
        Kumar community from both Dakhinpat Kumar Gaon and Salmora has gone through a major crisis due to river bank erosions per se; the loss of specific types of soil for pottery making has created threat for the traditional livelihood acutely. This in turn affects the islander primarily women potters’ source of income. As seen in the first picture this type of clay is obtained from clay pits from about twenty-five to thirty feet depth near the river banks and the sources for this clay are extremely limited.
        
        Largely, this clay can be procured from riverbanks, which is constantly eroding. Over the year the traditional potters are forced to use sand or use inferior quality soil (a type of soil locally called ‘Lodha-maati’) this not only gives the pots a low-quality finish but also potters get less price for such pots.`,
  ...
  },
  {
    ...
    He started his entrepreneurial journey during his college days, and now he is exploring the possibilities in industrial design sector. Apart from being an entrepreneur Sumit has also placed himself as a mixed media artist by practicing photography, generative art, experimental cinematography, and sound installations, and have also exhibited internationally. 
    
    He believes in finding the subtle balance between art and technology through his personal practices and while doing so, he intends to address complex societal issues to create a meaningful impact`,
    twitter: "@Baruah_Da",
  ...
  },
  {
    ...
    writeup: `Pushing oneself harder for the peak: The villagers’ returns home after their daily work in the markets. The land near the river bank is very fertile. They cultivate their vegetables and sell them in the markets in nearby town. We can see two villagers in the photograph returning home after their work in the market.
    
    River Kingdom: This photograph is of little kids from the outskirt villages of Tezpur city. Most of the immigrants resides in the outskirt villages on the Brahmaputra river bank. During evening the village kids came to play, fish and have their evening bath. 
    
    Infinite: This photograph is of 10 year old Nikita Rajbongshi, belongs to a fisherman family who resides at the bank of river Brahmaputra in Tezpur, Assam. She studies in Kolibari School in class 5. In this photograph she stares at the vast river view from her home where the horizon over the river goes invisible. 
    
    Dusk choirs: This photograph is of cattle herders returning with their herd during sunset in the bank of river Brahmaputra. The vast stretch of sand makes a spectacular sunset creating a surreal ambience.`,
  ...
  },
  {
    ...
    title: `Living with the river`,
    writeup: `Daily Activities: A lot of daily activities and daily chores can be usually seen on the banks of the brahmaputra. It is evident from the scene here where people can be seen brushing teeth, bathing, swimming, applying oil on their bodies on a cold winter morning in guwahati.
    
    A Boy Cycling In Floods: A young boy plays with his bicycle in the paddy field which is completely submerged by the flood due to incessant monsoon rains at a village close to the banks of river brahmaputra on the outskirts of guwahati city.
    
    Washermen and Fishermen: The river brahmaputra is a major source of livelihood for many people in assam. On a cold foggy morning, a washerman half submerged in the chilly water of the river is seen washing piles of clothes and in the background can be seen a boat with fishermen on it starting their day to catch fish in the river.

    Catching A Fish: Fishing is a major source of livelihood and income in assam with majority of the fishing happening in the river brahmaputra. Here a fisherman is seen showing off a freshly caught fish which is estimated to be around 4-5 kgs in weight.
    
    Women in a boat: A woman rowing her boat and making her way to a nearby roadhead to ferry people and essentials back to nearby villages which are mostly submerged by flood in the panikhaiti area of assam near guwahati city.`,
  ...
  },
  {
    ...
    writeup: `The Brahmaputra On a boat ride on the Brahmaputra in the year 2016, what struck me most was the colour theme all along the trip – different shades of grey. The sky, the waters, all a spectrum of grey but the banks were a riot of green hues and dotted with people wearing vibrant colours. The animal life, also. Is mostly shades of grey except for the colourful kingfisher and other birds and the golden hued deer. People had happy faces, living in settlements all along the river. They seem to have simple lifestyles, dependent on river biodiversity, taking only as much as is required for sustenance. Other species live peaceably, well camouflaged and perhaps instinctively staying away from poachers. The River has a vibrant ecosystem whose constitutents complement each other.`,
  ...
  },
  {
    ...
    writeup: `As with every river, fishing has been one of the popular sources of income for the families that dwell along the river, but given the size and flow of the mighty Brahmaputra, it is not as extensive as other rivers. My time that I spent at IITG, I got an opportunity to interact with the locals as well as understand the economy of this rural portion of Kamrup District. And given the low opportunity in farming, people actually see river as part of their lives. 
    
    Some large and small-scale industries have come up in the last decade or two, but the region hasn’t transformed to put it simply. This is a monochrome image that I clicked during my morning cycling ride over one weekend. I hope people like it!`,
...

  {
    ...
    writeup: `Walking by the ghat, like every proud Guwahatian, I have always admired the scenic beauty of the mighty Brahmaputra. As the sun sets, the parakeets fly back home, and the wind blowing on my face makes me believe in magic. But how does the Brahmaputra see us? 
    
    A field study gave me the opportunity to see the city through his eyes. The rituals might bring peace to the departed soul, but the river isn’t at peace. The Bharalu brings the entire cities waste to the Brahmaputra. A stark contrast of color where the untreated waste meets the river. A river has a natural capacity for rejuvenation. But how much is too much? The view isn’t pretty from the other side.`,
  ...
  },
  {
    ...
    Every year, the dynamic changes that occur destroy and create new habitats. But, riverine grasslands play a critical role in slowing erosion. The river banks and char-chaporis are home to a variety of grasses and plants from the genus Saccharum, Typha, Tamarix, and others. Many of these grasses are used for nest making by grassland specialist birds. Unfortunately, these grasses are harvested in excess and sold as fodder. The grazing of livestock in these grasslands also degrades the grasslands' quality. They also aid in the propagation of weeds in these grasslands, speeding up the rate of succession.
    
    Similarly, sand mining is rampant in some areas, and it is only getting worse as time goes on. Grasslands are ploughed down or burned to make way for agriculture. While common birds adapt well, many grassland endemics flee to find suitable habitats away from agricultural patches. Because of these unsustainable agricultural practises, sometimes entire chars are eroded away in an year's flood.
    
    As a matter of fact, it is critical to thoroughly understand the biodiversity of the Brahmaputra, and initiatives for conservation and proper management of riverine grasslands should be undertaken before it is too late`,
...
Awarded a scholarship to undergo mobile journalism in Albania.`,
...

  {
    ...
    writeup: `The mighty river Brahmaputra has provided the people of Assam and all the regions it flows through with not only food and water but also has provided the people with a source of employment. Fresh water fishing is the primary source of income for hundreds if not thousands of people living by this mighty river. For centuries, hundreds of families have been dependent on the river for their food, clean water and fishing as an employment opportunity. 
